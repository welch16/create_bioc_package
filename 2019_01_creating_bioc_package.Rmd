...
```{r available_packages,echo=FALSE,out.width="850px"}

knitr::include_url("https://bioconductor.org/packages/release/BiocViews.html")
...
.center.top[.font3.light-green[NAMESPACE]]
...
```{r chipexoqual_vignette, echo=FALSE,out.width="750px"}

knitr::include_url("https://bioconductor.org/packages/release/bioc/vignettes/ChIPexoQual/inst/doc/vignette.html")
...
```{r chipexoqual_checks,echo=FALSE,out.width="1000px"}

knitr::include_url("https://www.bioconductor.org/checkResults/3.8/bioc-LATEST/ChIPexoQual/malbec1-checksrc.html")
...
```{r chipexoqual_stat,echo=FALSE,out.width="950px"}

knitr::include_url("http://bioconductor.org/packages/stats/bioc/ChIPexoQual/")
